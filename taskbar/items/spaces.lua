...
local app_icons = require("taskbar.helpers.app_icons")
...
for i = 1, 10, 1 do
  ...
  space:subscribe("space_change", function(env)
    ...
    space:set({
      ...
      background = {
        border_color = selected and colors.active_border_color or colors.grey,
      },
    })
    space_bracket:set({ background = { border_color = colors.grey } })
  end)
